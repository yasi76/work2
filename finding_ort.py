#!/usr/bin/env python3
"""
Script to find city (Ort) information for startup URLs.
Loads URLs from JSON files, uses hardcoded mappings, and scrapes when necessary.
"""
...
def main():
    ...
    print("Starting Ort (city) finding process...")
